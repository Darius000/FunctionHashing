...
void NodeElement::DrawElement(ImDrawList* drawlist)
{
	...
	DrawHeader(headerbb.Min, headerSize, ImVec4(1.0f, 0.0f, 0.0f, 1.0f), node_rounding, ImDrawCornerFlags_Top, nodeDrawList);

	DrawTitle("Node Title", headerbb.Min + ImVec2(node_rounding, 0.0f), {}, nodeDrawList);
